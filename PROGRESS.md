...
## Current step
M2 — Storage. IndexedDB CRUD (idb) for observations + baseline, plus exportAll().

## Next action (resume here)
Move to M3: per-signal robust baseline model (median/MAD + EWMA) in src/baseline/, online-updatable, missing-day tolerant.
